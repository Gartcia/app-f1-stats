...
export function AppBottomNav({ activePath }: Props) {
  return (
    <nav className="sticky bottom-4 z-20">
      <div className="mx-auto flex w-full max-w-3xl items-center justify-between gap-2 rounded-2xl border border-white/10 bg-zinc-950/90 p-2 shadow-2xl backdrop-blur">
        {items.map((item) => {
